...
#   1. determine how much noise to add
#   2. how do curves change as you decrease number of patients 
#
...
# Load data
##############
file <- read.csv(file = "expand_no_missing_study1_subsample100.csv", header = TRUE, stringsAsFactors = FALSE)
# file <- read.csv(file = "expand_no_missing_study1_subsample100.csv", header = TRUE, stringsAsFactors = FALSE)
#file <- read.csv(file = "https://raw.githubusercontent.com/neelsoumya/survival_curve_privacy_prototype/main/expand_no_missing_study1_subsample10.csv", header = TRUE, stringsAsFactors = FALSE)
...
# TODO: make f dependent on number of patients?
